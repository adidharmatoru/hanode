...
exports.profitandlossOG = function(req, res, next) {
  ...
  var sql = 'select   P1."DocNum",   P1."DocEntry",  P1."Series",   P2."PrjName",  P1."DocTotal" as "DocTotalOG",   P1."PrjCode",  P1."DocType"from   ovpm P1   join oprj P2 on P1."PrjCode" = P2."PrjCode" order by   P2."PrjCode" desc';
...
exports.profitandlossSO = function(req, res, next) {
  ...
  var sql = 'SELECT   distinct T0."Project" as "PrjCode",   T1."DocNum" as "SO DocNum",   left(T1."DocDate", 10) as "SO Date",  T1."CardName" as "Customer",   T1."NumAtCard" as "PO",   T1."DocTotal" as "DocTotalSO",   T1."U_VIT_TOPY"FROM   RDR1 T0   JOIN ORDR T1 ON T1."DocEntry" = T0."DocEntry"   join oprj prj on T0."Project" = prj."PrjCode" where   T0."Price" != 0 order by   T0."Project" desc';
...
exports.emailbpseluruhcustomer = function(req, res, next){
  ...
  var sql = 'select   C1."CardName",   C1."CardCode",  C1."E_Mail",  C2."Name",  C2."E_MailL"from   ocrd C1   left join ocpr C2 on C1."CardCode" = C2."CardCode" where C1."CardType" = '+ "'C'" +' and C1."VatStatus" = '+ "'Y'" +'';
