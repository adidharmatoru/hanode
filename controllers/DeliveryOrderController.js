...
exports.serialNum = function(req, res)
{
  ...
  var sql ='select ns."customer",ns."custmrName", ns."instLction",ns."internalSN",pr."CntctCode",pr."Tel1",pr."Name" from oins ns left join ocpr pr on ns."customer"=pr."CardCode" where "internalSN" LIKE  ' + "'%" + req.query.code + "%'" + '';
