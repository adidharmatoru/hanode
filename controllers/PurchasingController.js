...
exports.outstandingpo = function(req, res, next) {
  ...
  var sql = 'select "DocNum", "DocEntry", "NumAtCard", SUBSTRING( "CreateDate",1,10) as "CreateDate", "U_DRS_NUMBER_OA" from opor where "U_DRS_NUMBER_OA" is null and "CANCELED" = ' + "'" + 'N' + "'" + ' and LEFT("CreateDate", 4) = ' + "'" + shortYear + "'" + '';
