...
exports.sqssdetail = function(req, res, next) {
  ...
  var sql = 'select   T1."DocNum",  T3."SrcvCallID",  T5."ItemCode",  T5."Dscription",  T5."Quantity"  from oqut T1 left join nnm1 T2 on T1."Series" = T2."Series" left join qut1 T5 on T1."DocEntry" = T5."DocEntry" where T1."DocStatus" = ' + "'" + 'O' + "'" + ' and left(T2."SeriesName", 4) = ' + "'" + 'SQSS' + "'" + ' and T1."DocNum" = ' + "' " + req.query.code + " '" + '';
...
exports.sqss = function(req, res, next) {
  ...
  var sql = 'select   T1."DocNum",T1."DocEntry" from oqut T1 left join nnm1 T2 on T1."Series" = T2."Series" where T1."DocStatus" = ' + "'" + 'O' + "'" + ' and left(T2."SeriesName", 4) = ' + "'" + 'SQSS' + "'" + ' AND T1."DocNum" LIKE ' + "'%" + req.query.code + "%'" + '';
...
exports.inhousesc = function(req, res, next) {
  ...
  var sql = 'select T4."DocNum",  T4."internalSN",  T4."itemCode",  T4."itemName",  T4."custmrName",  T4."customer",  T4."Series"from  scl4 T3  left join oscl T4 on T3."SrcvCallID" = T4."callID" where  T3."DocAbs" =  ' + "' " + req.query.code + " '" + '';
