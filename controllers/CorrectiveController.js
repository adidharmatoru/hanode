...
exports.salesQuotation = function(req, res, next) {
  ...
  var sql = 'select distinct T3."DocNum" as "DocNum", T2."TrgetEntry" as "TargetEntry", T3."DocEntry" as "DocEntry" from qut1 T2 left join oqut T3 on T2."DocEntry"=T3."DocEntry" where T3."DocEntry" in (' + req.body.sq + ')';
