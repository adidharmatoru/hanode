...
var sql = 'select T1."ItemCode",T2."WhsCode",T1."OnHand",T1."IsCommited",T1."OnOrder" from oitw T1 join owhs T2 on T1."WhsCode"=T2."WhsCode" where T1."ItemCode" in (' + req.query.code + ') and T2."WhsCode" in (' + "'BITRFS'" + ',' + "'PIKRFSNB'" + ',' + "'PIKRFS'" + ',' + "'KTBRFS'" + ',' + "'BMSRFS'" + ',' + "'BMSRFSNB'" + ',' + "'CBTRFS'" + ')';
