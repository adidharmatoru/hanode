...
var sql = 'select T0."DocEntry",T0."DocNum as "DocNum","T1."NumAtCard" as "NomorPO", T0."Quantity",SUBSTRING(T0."ShipDate",1,10) as "ShipDate",T0."ItemCode", T2."SlpName" as "SalesName" from rdr1 T0 join ordr T1 on T0."DocEntry" = T1."DocEntry" left join oslp T2 on T1."SlpCode"=T2."SlpCode" where T0."ItemCode" in (' + req.query.code + ') and T1."CANCELED" = ' + "'" + 'N' + "'" + ' and T1."DocStatus" = ' + "'" + 'O' + "'" + '  and T0."LineStatus"=' + "'" + 'O' + "'" + ' and T0."InvntSttus"=' + "'" + 'O' + "'" + '';
