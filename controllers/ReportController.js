...
exports.sotidakadasq = function (req, res) {
  res.setHeader('Access-Control-Allow-Origin', '*');
  var sql = 'select   r1."DocNum",   r1."CardName",   r1."NumAtCard",   Q1."DocEntry" from   ordr r1   left join rdr1 r2 on r1."DocEntry" = r2."DocEntry"   left join qut1 Q1 on r2."BaseEntry" = Q1."DocEntry"   and r2."BaseLine" = Q1."LineNum" or Q1."DocEntry" = r2."TrgetEntry" and r2."BaseLine" = Q1."LineNum"where   r1."OwnerCode" = 656   and r2."BaseEntry" is null and Q1."DocEntry" is null or r2."TrgetEntry" is null and  r1."OwnerCode" = 656 and Q1."DocEntry" is null order by   r1."DocNum"';
  connection.runQuery(res, sql)
}
