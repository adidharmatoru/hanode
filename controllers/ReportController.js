...
var sql = 'select T0."DocEntry", T0."Quantity",SUBSTRING(T0."ShipDate",1,10) as "ShipDate",T0."ItemCode" from por1 T0 join opor T1 on T0."DocEntry" = T1."DocEntry" where "ItemCode" in (' + req.query.code + ') and T1."CANCELED" = ' + "'" + 'N' + "'" + ' and T1."DocStatus" = ' + "'" + 'O' + "'" + '';
