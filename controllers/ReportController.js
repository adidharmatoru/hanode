...
exports.itemsReadyForSales = function (req, res, next) {
  var sql='select oitm."ItemCode",oitm."ItemName", oitb."ItmsGrpNam", oitm."OnHand", oitm."IsCommited", oitm."OnOrder",Sum(oitm."OnHand") - Sum(oitm."IsCommited") as "Available" from oitm join oitb on oitb."ItmsGrpCod" = oitm."ItmsGrpCod"'
