...
exports.so = function(req, res, next) {
  ...
  var sql = 'select "CardCode","DocEntry","DocNum","CardName","Address","NumAtCard","DocTotal","CntctCode" from ordr where "Series"= ' + "'1674'" + ' and "CardCode" in (' + "'" + req.query.code + "'" + ') order by "DocNum" ASC';
