...
exports.serialNum = function(req, res, next) {
  ...
  var sql = 'select "dlvryDate","internalSN","customer","contactCod","itemName" from oins Where "internalSN" LIKE  ' + "'%" + req.query.code + "%'" + ' AND "status"='+"'A'"+' order by "internalSN"';
  // var sql = 'select "ItemCode","ItemName" from oitm order by "ItemCode"';
  connection.runQuery(res, sql);
};
