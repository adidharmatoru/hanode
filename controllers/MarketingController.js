...
exports.Scall = function(req, res, next) {
  ...
  var sql = 'SELECT distinct T0."contractID" as "ContractNo", T0."callID" as "SC_no", SUBSTRING(T0."createDate",1,10) as "SC_date", SUBSTRING(T0."cntrctDate",1,10) as "SC_enddate" FROM OSCL T0 where T0."contractID" in (' + req.body.cid + ') order by T0."contractID"';
