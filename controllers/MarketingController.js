...
exports.ScallDetail = function(req, res, next) {
  ...
  var sql = 'select T0."custmrName" as "Name",T0."BPShipAddr" as "Address",T0."internalSN" as "SerialNum",T0."itemCode" as "ItemCode",T0."itemName" as "ItemName",T0."U_VIT_BMRK" as "MerkBatterai",T0."U_VIT_BMOD" as "ModelBatterai",SUBSTRING(T0."U_VIT_BDAT",1,10) as "DateBatterai",T0."U_VIT_BPCS" as "BatteraiPCS",T0."U_VIT_TINR" as "Tegangan in R",T0."U_VIT_TINS" as "Tegangan in S",T0."U_VIT_TINT" as "Tegangan in T",T0."U_VIT_TOUR" as "Tegangan out R",T0."U_VIT_TOUS" as "Tegangan out S",T0."U_VIT_TOUT" as "Tegangan out T",SUBSTRING(T1."StartDate",1,10) as "StartDate",SUBSTRING(T1."EndDate",1,10) as "EndDate" from oscl T0 join octr T1 on T0."contractID"=T1."ContractID"  where T0."callID" = ' + "'" + req.query.code + "'" + '';
